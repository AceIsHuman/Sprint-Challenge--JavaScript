...
const tyrannosaurus = {name: `tyrannosaurus`, diet: `carnivorous`, weight: `7000kg`, length: `12m`, period: `Late Cretaceous`, roar: function(){ return `RAWERSRARARWERSARARARRRR!`}};
...
*/
const populationTotal = zooAnimals.reduce((previousVal, currentVal) => currentVal.population + previousVal, 0);
